"""Run a LoRA quick training job with LLaMA-Factory."""
import argparse
import os
import shutil
import subprocess
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs" / "lora_quick.yaml"
...
DEFAULT_LOG_FILE = PROJECT_ROOT / "outputs" / "logs" / "train_lora_quick.log"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run LoRA quick training.")
